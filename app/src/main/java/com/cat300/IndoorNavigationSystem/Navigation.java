...
public class Navigation extends FragmentActivity
    ...
    private final List<Marker> mPoIMarkers = new ArrayList<>();
    ...
    private final IAWayfindingListener mWayfindingListener = new IAWayfindingListener() {
        @Override
    ...
    private final IAOrientationListener mOrientationListener = new IAOrientationListener() {
        @Override
     ...
     */
    private final IALocationListener mListener = new IALocationListenerSupport() {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchFab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent searchIntent = new Intent(Navigation.this, Search.class);
